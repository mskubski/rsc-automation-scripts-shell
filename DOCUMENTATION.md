# RSC Automation Scripts — Documentation

Scripts for automating operations against the **Rubrik Security Cloud (RSC) GraphQL API**.
...
The `/restore` directory is created automatically on the VM if it does not exist.
